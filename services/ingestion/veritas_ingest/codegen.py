...
def generate_package(prompt: str, language: str, cfg: dict[str, Any]) -> dict[str, Any]:
    ...
    Acceptance criteria:
        ...
        3. Mark generated code as production_candidate_validated only after validation gates pass in the active run loop.
